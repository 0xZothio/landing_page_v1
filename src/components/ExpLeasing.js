        ...
        <div className="grid grid-cols-1 md:grid-cols-8 gap-2 mb-10 p-10 place-content-center place-items-center">
          <div className="col-span-4">
            ...
            <div className="tracking-wide leading-relaxed">
              Leasing is a simple contractual arrangement calling for the lessee
              (user) to pay the lessor (owner) regular payments in exchange for
              use of an asset over an agreed period of time. Furniture, vehicles
              and equipment are among the most common assets that are leased
              investment in leases allows you to invest in an asset (like
              vehicles, furniture, electronics) and lease it to a company
              against fixed monthly returns Companies are able to use leased
              assets to scale faster, while the investors are able to enjoy
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="  bg-[#111111] rounded-lg p-6">
                  ...
                  <div className="text-sm">
                    Companies benefit from leased assets to scale their business
                    faster
                  </div>
                </div>
                ...
                <div className="  bg-[#111111] rounded-lg p-6">
                  ...
                  <div className="text-sm">
                    Investments start at just ₹10,000 and offer the potential to
                    earn up to 16-20% Pre-Tax IRR.
                  </div>
                </div>
                ...
                <div className="  bg-[#111111] rounded-lg p-6">
                  ...
                  <div className="text-sm">
                    Leasing agreements typically have a tenure of 12-36 months,
                    providing a reliable source of passive income for investors.
                  </div>
                </div>
                ...
                <div className="  bg-[#111111] rounded-lg p-6">
                  ...
                  <div className="text-xs text-gray-500">
                    Overall, investing in asset leasing can be a smart financial
                    decision for investors looking to diversify their
                    portfolios, generate steady income, and potentially benefit
                    from tax advantages. However, as with any investment
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="  bg-[#111111] rounded-lg p-6">
                  ...
                  <div className="text-sm">
                    Zoth evaluates the risk profile of each leasing opportunity
                    and presents it to investors in a clear and transparent
                    manner.
                  </div>
                </div>
                ...
                <div className="  bg-[#111111] rounded-lg p-6">
                  ...
                  <div className="text-sm">
                    Zoth conducts a comprehensive financial analysis of leasing
                    opportunities, including an analysis of annual reports, key
                    contracts, and regulatory concerns.
                  </div>
                </div>
                ...
                <div className="  bg-[#111111] rounded-lg p-6">
                  ...
                  <div className="text-sm">
                    With investment opportunities starting at just ₹10,000, Zoth
                    makes it easy for investors of all levels to participate in
                    asset leasing.
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 p-2 text-xs text-center">
                Overall, Zoth is a trusted platform that provides investors with
                access to high-quality leasing opportunities and a reliable
