...
export const PaymentPopup = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bg-[#171717]/80 flex justify-center items-center backdrop-blur z-50 w-full  p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
      <div className="relative w-1/2 h-full  md:h-auto bg-[#171717] rounded-xl shadow">
