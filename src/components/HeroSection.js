      ...
      <main>
        <div className="relative px-6 lg:px-8">
          <div className="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
            <div>
              <div>
                <h1 className="text-4xl font-bold leading-8 sm:text-center sm:text-6xl">
                ...
                <div className="mt-8 flex gap-x-4 sm:justify-center">
                  <a
                    href="#"
                    className="inline-block rounded-full px-4 py-1.5 text-base font-semibold leading-7 text-black shadow-sm ring-1 ring-black bg-white"
                  >
                    Get Exclusive Invite{" "}
                  </a>
                  <div class=" eft-1/2 -ml-0.5 w-0.5 h-100 bg-gray-600"></div>
                  <p className=" text-sm mx-4 sm:text-center">
                    Join the Zoth Club
                  </p>
                </div>
