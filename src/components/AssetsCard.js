...
export const AssetsCard = () => {
  return (
    <div id="" className="bg-black text-white w-full h-full sm:mt-14">
      <motion.div
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10 p-10 place-content-center place-items-center ">
        ...
        <div className="bg-[#161616] rounded-lg">
          ...
          <div className="rounded-lg bg-[#272727]">
            <div className="grid grid-cols-2 gap-2">
              <div className="p-4">
                <div className="tracking-wide">Earn Upto</div>
                <div className="text-md p-1">
                  <span className="font-extrabold">16-20% </span> Pre-tax IRR
                </div>
              </div>
              <div className="p-4">
                <div className="tracking-wide">Tenure</div>
                <div className="text-md p-1">
                  <span className="font-extrabold">12-36</span> months
                </div>
              </div>
              <div className="p-4">
                <div className="tracking-wide">Investments starting at</div>
                <div className="text-md p-1">
                  <span className="font-extrabold">₹10,000</span>
                </div>
              </div>
              <div className="p-4">
                <div className="tracking-wide">Non-Market Linked</div>
                <div className="text-md p-1">
            ...
            <div className="flex justify-center items-center w-full p-4">
              <button class="w-3/4 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                Explore
              </button>
            </div>
          </div>
        ...
        {/* Invoice */}
        <div className="bg-[#161616] rounded-lg">
          <div className="text-white text-3xl font-bold p-4">Invoice Discounting</div>
          <div className="rounded-lg bg-[#272727]">
            <div className="grid grid-cols-2 gap-2">
              <div className="p-4">
                <div className="tracking-wide">Earn Upto</div>
        ...
        <div className="bg-[#161616] rounded-lg grayscale ">
          <div className="text-gray-500 text-3xl font-bold p-4">Commercial Real Estate</div>
          <div className="rounded-lg bg-[#272727]/30">
            <div className="grid grid-cols-2 gap-2">
              <div className="p-4 text-gray-500">
                <div className="tracking-wide capitalize">targeted IRR</div>
                <div className="text-md p-1">
                  <span className="font-extrabold">8-12% </span>
                </div>
              </div>
              <div className="p-4 text-gray-500">
                <div className="tracking-wide">Rent Escalation</div>
                <div className="text-md p-1">
